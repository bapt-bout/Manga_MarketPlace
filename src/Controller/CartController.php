...
class CartController extends AbstractController
{
    ...
    public function commander(CartService $cs, EntityManagerInterface $manager)
    {
        ...
        foreach($cartWithData as $data):
            ...
            {
                $this->addFlash('danger',"vous avez dépassez le nombre de $data[produit] disponible, nous avons modifier votre quantité de ce produit");
        ...
        $manager->flush();
        $cs->deleteCart();
        $this->addFlash('success',"Votre commande a été validé, elle est en cours de traitement. Retrouvez les détails sur votre profil");
        return $this->redirectToRoute('home');
